...
# Abrindo uma nova conexão com o banco de dados para criar VIEWS para análise dos dados
creating_views()

# Criando primeiro gráfico e primeira tabela
chart_cats()

# Criando segundo gráfico e segunda tabela
chart_livros()

# Criando terceiro gráfico e terceira tabela
